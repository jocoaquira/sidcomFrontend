...
export class AnularFormularioExternoComponent implements OnInit {
    ...
    public error!:any;
    public formulario_ext:IFormularioExterno={
      id:null,
      user_id:null,
      operador_id:null,
      nro_formulario:null,
  ...
  onSubmit(){
    ...
    if(this.valido)
    {
        ...
        this.formularioExternoService.anularFormularioExterno(this.formulario_ext).subscribe(
            (data:any) =>
            {
              //let sw:boolean=
              this.formulario_ext= this.formularioExternoService.handleEditarFormularioExterno(data);
