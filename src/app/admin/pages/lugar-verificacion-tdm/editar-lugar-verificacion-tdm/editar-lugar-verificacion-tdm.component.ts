...
@Component({
  selector: 'app-editar-lugar-verificacion-tdm',
  templateUrl: './editar-lugar-verificacion-tdm.component.html',
  styleUrls: ['./editar-lugar-verificacion-tdm.component.scss']
})
export class EditarLugarVerificacionTDMComponent implements OnInit {
  ...
  constructor(
    ...
    private actRoute:ActivatedRoute,
        ...
        this.lugarVerificacionTDMService.verLugarVerificacionTDM(this.id.toString()).subscribe(
        (data:any)=>{
