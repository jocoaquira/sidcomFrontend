...
import { CrearLugarVerificacionTDMComponent } from './crear-lugar-verificacion-tdm.component';
...
@NgModule({
  ...
  declarations: [CrearLugarVerificacionTDMComponent]
})
export class CrearLugarVerificacionTDMModule { }
