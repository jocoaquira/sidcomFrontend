...
@Component({
    ...
    styleUrls: ['./listar-municipios.component.scss'],
    providers: [MessageService]
})
export class ListarMunicipioComponent implements OnInit {

    public listaMunicipios!:IMunicipio[];
    ...
    findIndexById(id: number): number {
        ...
        for (let i = 0; i < this.listaMunicipios.length; i++) {
            if (this.listaMunicipios[i].id === id) {
                index = i;
                break;
            }
        }
    ...
    bloquearDialogo(municipio:IMunicipio){
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                ...
                this.municipioService.editarmunicipio(municipio).subscribe(
                    (data:any) =>
                    {
