...
@Component({
  selector: 'app-crear-tranca',
  templateUrl: './crear-tranca.component.html',
  styleUrls: ['./crear-tranca.component.scss']
})
export class CrearTrancaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.departamentosService.verdepartamentos(this.nombre).subscribe(
      ...
      // Para asignar todos los valores del formulario (debe incluir todos los campos)
        this.tranca.formulario.get('departamento_id')?.setValue(4);
