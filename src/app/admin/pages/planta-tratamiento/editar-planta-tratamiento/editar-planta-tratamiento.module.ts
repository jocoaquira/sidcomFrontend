...
import { EditarPlantaDeTratamientoComponent } from './editar-planta-tratamiento.component';
...
@NgModule({
  ...
  declarations: [EditarPlantaDeTratamientoComponent]
})
export class EditarPlantaDeTratamientoModule { }
