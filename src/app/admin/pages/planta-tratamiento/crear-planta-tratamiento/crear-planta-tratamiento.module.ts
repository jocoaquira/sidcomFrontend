...
import { CrearPlantaDeTratamientoComponent } from './crear-planta-tratamiento.component';
...
@NgModule({
  ...
  declarations: [CrearPlantaDeTratamientoComponent]
})
export class CrearPlantaDeTratamientoModule { }
