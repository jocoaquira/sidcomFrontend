...
@Component({
  selector: 'app-anular-formulario-interno-cooperativa',
  templateUrl: './anular-formulario-interno-cooperativa.component.html',
  styleUrls: ['./anular-formulario-interno-cooperativa.component.scss'],

})
export class AnularFormularioInternoCooperativaComponent implements OnInit {
    public id!:any;
