...
@Component({
  selector: 'app-crear-vehiculo-admin',
  templateUrl: './crear-vehiculo-admin.component.html',
  styleUrls: ['./crear-vehiculo-admin.component.scss']
})
export class CrearVehiculoAdminComponent implements OnInit {

  @Input() usuario!:IVehiculoAdmin;
