...
@Component({
  selector: 'app-ver-minerales-top-tdm',
  templateUrl: './ver-minerales-top-tdm.component.html',
  styleUrls: ['./ver-minerales-top-tdm.component.scss']
})
export class VerMineralesTopTDMComponent implements OnInit {
    //@Input() id!: number;
  ...
  constructor(
    private formInterno:TomaDeMuestraService,
  ) {}
