...
@Component({
  selector: 'app-ver-minerales-top-externo',
  templateUrl: './ver-minerales-top-externo.component.html',
  styleUrls: ['./ver-minerales-top-externo.component.scss']
})
export class VerMineralesTopExternoComponent implements OnInit {
    //@Input() id!: number;
  ...
  constructor(
    private formInterno:FormularioExternosService,
  ) {}
