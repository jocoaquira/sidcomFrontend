                      ...
                      logo.onload = () => {
                        ...
                        autoTable(doc, {
                          ...
                          autoTable(doc, {
                            ...
                            head: [
                              [
                                { content: 'DATOS DE VERIFICACIÓN Y APROBACIÓN', colSpan: 3, styles: { halign: 'center', fillColor: [255, 255, 255], fontStyle: 'bold' } },
                              ],
                            ],
                            body: [
                              [
                                ...
                                { content: 'Escanee el código QR para verificar la autenticidad del Formulario de Toma de Muestra', styles: { halign: 'center', fontStyle: 'bold', fillColor: [255, 255, 255], fontSize: 7 } },
                              ],
                            ],
                            ...
                            columnStyles: {
                              0: { cellWidth: 205, minCellHeight: 100, fillColor: [255, 255, 255] }, // Fondo blanco para la primera columna
                              1: { cellWidth: 205 }, // Primera columna
                              2: { cellWidth: 120 },
                            },
                          });
                          ...
                          sello_auth.onload = () => {
                            ...
                            sello_autorizado.onload = () => {
                                if(toma_de_muestra.estado!=='GENERADO')
                                {
                                    doc.addImage(url, 'PNG', 475, (doc as any).lastAutoTable?.finalY-120, 81, 81);
                                }
                                else
                                {
                                    
                                    doc.addImage(sello_auth, 'JPEG',452, (doc as any).lastAutoTable?.finalY-110, 127,86);
                                }
