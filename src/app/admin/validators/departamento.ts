...
export class DepartamentoFormulario {
  ...
  constructor() {
    ...
    this.formulario = new FormGroup({
        id: new FormControl(this.departamento.id),
        nombre:new FormControl(this.departamento.nombre,[Validators.required,Validators.pattern('^[a-zA-ZÀ-ÿ\\s(),]+$')]),
        latitud:new FormControl(this.departamento.latitud,[Validators.required, Validators.pattern('^[a-zA-ZÀ-ÿ\\s(),]+$')]),
        longitud:new FormControl(this.departamento.longitud,[Validators.required])
    });
  }
