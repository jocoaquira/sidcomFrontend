...
export class OperatorFormulario {
  ...
  constructor() {
    ...
    this.formulario = new FormGroup({
        ...
        rep_nombre_completo:new FormControl(this.operator.rep_nombre_completo,[Validators.required,Validators.pattern('^[a-zA-Z�-�\\u00d1\\u00f1\\s]+$')]),
        ...
        generacion_nro_lote:new FormControl(this.operator.generacion_nro_lote,[Validators.required]),
