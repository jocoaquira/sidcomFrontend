...
export class OperatorFormulario {
  ...
  constructor() {
    ...
    this.formulario = new FormGroup({
        ...
        dl_departamento:new FormControl(this.operator.dl_departamento,[Validators.required,Validators.pattern('^[0-9]*$')]),
        dl_municipio:new FormControl(this.operator.dl_municipio,[Validators.required,Validators.pattern('^[0-9]*$')]),
        ...
        nim_niar:new FormControl(this.operator.nim_niar,[Validators.required]),
        ...
        created_at:new FormControl(this.operator.dl_ubicacion),
        updated_at:new FormControl(this.operator.dl_ubicacion),
        vencimiento_ruex:new FormControl(this.operator.vencimiento_ruex),
