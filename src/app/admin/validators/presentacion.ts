...
export class PresentacionFormulario {
  mineral!: IPresentacion;
  ...
  constructor() {
    ...
    this.formulario = new FormGroup({
        ...
        humedad:new FormControl(this.mineral.humedad,[Validators.required, Validators.pattern('^[a-zA-ZÀ-ÿ\\s(),]+$')]),
        merma:new FormControl(this.mineral.merma),
        cantidad:new FormControl(this.mineral.cantidad,[Validators.required])
    });
  }
